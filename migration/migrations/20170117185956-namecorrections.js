...
module.exports = {
    up: function (queryInterface) {
        return queryInterface.removeColumn('consent_document', 'deleted_at')
            ...
            .then(() => queryInterface.sequelize.query('ALTER TABLE question_action_text DROP CONSTRAINT question_action_text_question_action_text_fkey'))
            ...
            .then(() => queryInterface.sequelize.query('ALTER TABLE question_action_text ADD CONSTRAINT question_action_text_question_action_id_fkey FOREIGN KEY (question_action_id) REFERENCES question_action'));
    },
