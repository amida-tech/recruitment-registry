...
const uploadCohortCSV = function zipAndUploadToS3(csv){
    return csvStringToFile(csv)
        ...
        .then(makeResponse, err => RRError.reject('S3 Upload error', err.code));
};

// req.models, s3Data
// reuse reset-token code here
function sendS3LinkEmail(models, s3Data) {
    
}

module.exports = {
    uploadCohortCSV: uploadCohortCSV,
    sendS3LinkEmail: sendS3LinkEmail,
};
