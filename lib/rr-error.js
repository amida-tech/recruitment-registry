...
errors.zipApiError = {
    msg: 'Zip code API gave error $0.',
};

errors.sectionNotFound = {
    msg: 'No such sections found',
};

errors.surveyImportMissingSectionId = {
    msg: 'Section id \'$0\' is not in the id map.',
};

errors.surveyImportMissingQuestionId = {
    msg: 'Question id \'$0\' is not in the id map.',
};

errors.surveyImportMissingParentSectionId = {
    msg: 'Parent section id \'$0\' is not in the id map.',
};

errors.surveyImportMissingParentQuestionId = {
    msg: 'Parent question id \'$0\' is not in the id map.',
};

errors.registryBothURLSchema = {
    msg: 'URL and schema cannot be both specied.',
};

errors.genericUnique = {
    msg: 'Record with $0 \'$1\' already exists.',
};

errors.registryNoneFound = {
    msg: 'No registries found in the system.',
};

errors.registryIdNotFound = {
    msg: 'No registry with id $0 is found in the system.',
};
