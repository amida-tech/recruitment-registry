        ...
        <ul>
          <section id="surveysToComplete">
            ...
            {this.props.data.map(survey => (
              ...
              <br/>
              <p>Fusce ut massa eu dolor convallis eleifend ut sed eros. Duis enim nisi, efficitur eu elit sed, facilisis sodales ex. Nulla pulvinar, metus vitae luctus vulputate, sapien ex iaculis nisl, sed consequat erat lorem a felis. In nec fringilla ligula. Ut ut turpis eu nulla laoreet porttitor vel nec tellus. Sed sed laoreet nisl. Maecenas augue nunc, suscipit sed nulla non, mattis malesuada magna. Mauris quis dignissim nibh.</p>
