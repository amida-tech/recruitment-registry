...
describe('survey consent integration', () => {
    ...
    _.range(10).forEach((i) => {
        it(`create consent type ${i}`, shared.createConsentTypeFn(rrSuperTest, hxConsentDocument));
    });
    ...
    [
        ...
        it(`create consent ${index}`, shared.createConsentFn(rrSuperTest, hxConsent, hxConsentDocument, typeIndices));
        it(`get/verify consent ${index}`, shared.verifyConsentFn(rrSuperTest, hxConsent, index));
    });

    it('create profile survey (survey 0)', shared.createProfileSurveyFn(rrSuperTest, hxSurvey));
    it('verify profile survey (survey 0)', shared.verifyProfileSurveyFn(rrSuperTest, hxSurvey, 0));
    ...
    _.range(10).forEach((i) => {
        it(`create consent document of type ${i}`, shared.createConsentDocumentFn(rrSuperTest, hxConsentDocument, i));
    });
    ...
    it('user 0 signs consent document 0', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 0, 0));
    it('user 0 signs consent document 1', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 0, 1));
    it('logout as user 0', shared.logoutFn(rrSuperTest));
    it('login as user 2', shared.loginIndexFn(rrSuperTest, hxUser, 2));
    it('user 2 signs consent document 0', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 2, 0));
    it('logout as user 2', shared.logoutFn(rrSuperTest));
    it('login as user 3', shared.loginIndexFn(rrSuperTest, hxUser, 3));
    it('user 3 signs consent document 1', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 3, 1));
    ...
    it('login as user 0', shared.loginIndexFn(rrSuperTest, hxUser, 0));
    it('user 0 signs consent document 3', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 0, 3));
    it('logout as user 0', shared.logoutFn(rrSuperTest));
    it('login as user 1', shared.loginIndexFn(rrSuperTest, hxUser, 1));
    it('user 1 signs consent document 1', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 1, 1));
    it('user 1 signs consent document 3', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 1, 3));
    it('logout as user 1', shared.logoutFn(rrSuperTest));
    it('login as user 2', shared.loginIndexFn(rrSuperTest, hxUser, 2));
    it('user 2 signs consent document 3', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 2, 3));
    it('logout as user 2', shared.logoutFn(rrSuperTest));
    ...
    _.range(4).forEach((index) => {
        ...
        it(`user ${index} signs consent document 2`, shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, index, 2));
        it(`logout as user ${index}`, shared.logoutFn(rrSuperTest));
    });

    it('login as user 1', shared.loginIndexFn(rrSuperTest, hxUser, 1));
    it('user 1 signs consent document 0', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 1, 0));
    it('logout as user 1', shared.logoutFn(rrSuperTest));
    it('login as user 3', shared.loginIndexFn(rrSuperTest, hxUser, 3));
    it('user 3 signs consent document 0', shared.signConsentTypeFn(rrSuperTest, hxConsentDocument, 3, 0));
    it('logout as user 3', shared.logoutFn(rrSuperTest));
    ...
    it('login as user 0', shared.loginIndexFn(rrSuperTest, hxUser, 0));
    it('user 0 bulk signs consent documents 4, 5, 6', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 0, [4, 5, 6]));
    it('logout as user 0', shared.logoutFn(rrSuperTest));
    it('login as user 1', shared.loginIndexFn(rrSuperTest, hxUser, 1));
    it('user 1 bulk signs consent documents 4, 5, 6, 7, 8, 9', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 1, [4, 5, 6, 7, 8, 9]));
    it('logout as user 1', shared.logoutFn(rrSuperTest));
    it('login as user 2', shared.loginIndexFn(rrSuperTest, hxUser, 2));
    it('user 2 bulk signs consent documents 4, 6, 8', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 2, [4, 6, 8]));
    it('logout as user 2', shared.logoutFn(rrSuperTest));
    it('login as user 3', shared.loginIndexFn(rrSuperTest, hxUser, 3));
    it('user 3 bulk signs consent documents 5, 7, 9', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 3, [5, 7, 9]));
    it('logout as user 3', shared.logoutFn(rrSuperTest));
    ...
    it('login as user 0', shared.loginIndexFn(rrSuperTest, hxUser, 0));
    it('user 0 bulk signs consent documents 7, 8, 9', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 0, [7, 8, 9]));
    it('logout as user 0', shared.logoutFn(rrSuperTest));
    it('login as user 2', shared.loginIndexFn(rrSuperTest, hxUser, 2));
    it('user 2 bulk signs consent documents 5, 7, 9', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 2, [5, 7, 9]));
    it('logout as user 2', shared.logoutFn(rrSuperTest));
    it('login as user 3', shared.loginIndexFn(rrSuperTest, hxUser, 3));
    it('user 3 bulk signs consent documents 4, 6, 8', shared.bulkSignConsentTypeFn(rrSuperTest, hxConsentDocument, 3, [4, 6, 8]));
    it('logout as user 3', shared.logoutFn(rrSuperTest));
