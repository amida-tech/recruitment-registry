...
module.exports = {
    ...
    questions: [{
        ...
        required: false,
        type: 'text',
        answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID28' },
    }, {
        ...
        required: false,
        type: 'text',
        answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID30' },
    }, {
        ...
        // },
        choices: [
            { text: 'Anti-depressant medication', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID18_1' } },
            { text: 'Anti-anxiety medication', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID18_2' } },
        ],
    }, {
        ...
        type: 'integer',
        multiple: true,
        answerIdentifiers: { type: 'bhr-gap-initial-m06-column', values: ['QID31_1', 'QID31_2'] },
    }, {
        text: 'How long in months has your current prescription been stable in dose?',
        required: false,
        type: 'integer',
        multiple: true,
        answerIdentifiers: { type: 'bhr-gap-initial-m06-column', values: ['QID32_1', 'QID32_3'] },
    }, {
        ...
        // },
        choices: [
            { text: 'Donepezil (Aricept)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_1' } },
            { text: 'Tacrine (Cognex)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_2' } },
            { text: 'Rivastigmine (Exelon)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_3' } },
            { text: 'Memantine (Namenda)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_4' } },
            { text: 'Galantamine (Razadyne)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_5' } },
            { text: 'Risperidone (Risperdal)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_6' } },
            { text: 'Paliperidone (Invega)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_7' } },
            { text: 'Olanzapine (Zyprexa)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_8' } },
            { text: 'Quetiapine (Seroquel)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_9' } },
            { text: 'Aripiprazole (Abilify)', answerIdentifier: { type: 'bhr-gap-initial-m06-column', value: 'QID19_10' } },
        ],
    }, {
        text: 'How long in months has your current prescription been stable in frequency?',
        required: false,
        type: 'integer',
        multiple: true,
        answerIdentifiers: { type: 'bhr-gap-initial-m06-column', values: ['QID34_1', 'QID35_1', 'QID36_1', 'QID37_1', 'QID38_1', 'QID39_1', 'QID40_1', 'QID41_1', 'QID42_1', 'QID43_1'] },
    }, {
        text: 'How long in months has your current prescription been stable in dose?',
        required: false,
        type: 'integer',
        multiple: true,
        answerIdentifiers: { type: 'bhr-gap-initial-m06-column', values: ['QID34_2', 'QID35_2', 'QID36_2', 'QID37_2', 'QID38_2', 'QID39_2', 'QID40_2', 'QID41_2', 'QID42_2', 'QID43_2'] },
    }, {
